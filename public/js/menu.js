 ...
 * button, nullschool-style. Tabs are hierarchical: the domains (Atmosphere, Ocean)
 * stack vertically, one is expanded at a time, and each domain shows a single
 * displayed layer — layers are never combined.
 */
(function () {
    "use strict";
